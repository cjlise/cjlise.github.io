...
* The workbook [rendering in html](https://github.com/cjlise/MachineLearning/blob/master/Airbnb-clustering.html): Save the file locally and load it in your Internet browser 
